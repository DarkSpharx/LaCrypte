...
let isLoading = true; // Variable pour indiquer si les données sont en cours de chargement
...
app.get('/gallerie', async (req, res) => {
  try {
    ...
    res.render('pages/gallerie', { images: imagesData, isLoading });
  } catch (err) {
    res.render('pages/gallerie', { images: [] , isLoading });
  }
});
